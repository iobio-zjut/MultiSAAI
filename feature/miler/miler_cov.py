...
def main():
    # fasta_dict1 = get_fasta_dict('./Pos_CGACGTTAGCTCCTCA-1_20250605_120619/heavy.fasta')
    # fasta_dict2 = get_fasta_dict('./Pos_CGACGTTAGCTCCTCA-1_20250605_120619/light.fasta')
    # fasta_dict3 = get_fasta_dict('./Pos_CGACGTTAGCTCCTCA-1_20250605_120619/antigen.fasta')
    ...
    # first_value_shape = first_value.shape
    # print("shape:", first_value_shape)
    # output_dir = './Pos_CGACGTTAGCTCCTCA-1_20250605_120619'
